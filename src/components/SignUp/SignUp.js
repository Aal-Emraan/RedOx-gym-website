...
const SignUp = () => {
    const {emailSignIn, googleSignIn} = useFirebase();
    ...
    return (
        <div className="w-50 mx-auto shadow p-4 rounded mt-5">
            <form>
                ...
                <input type="text" placeholder="Name" className="form-control bg-light shadow-sm p-3 mb-4 border-0" />
                ...
                <input type="submit" className="btn btn-danger d-block w-100 py-3 rounded-pill" value="Sign Up" onClick={emailSignIn(email, password)} />
